...
测试程序：
[strlenTest](https://dfjason.github.io/images/strlenTest.png)

测试结果：
[strlenTest2](https://dfjason.github.io/images/strlenTest2.png)
...
==注意：strtok函数执行的时候会修改他所处理的字符串，如果源字符串不能被修改，那就复制一份，将一份拷贝传给strtok函数==
  ...
  [1]: ./images/strlenTest.png "strlenTest.png"
  [2]: ./images/strlenTest2.png "strlenTest2.png"
